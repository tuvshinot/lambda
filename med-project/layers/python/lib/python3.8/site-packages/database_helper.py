...
def create_film_array_tables(conn):
    ...
    sql_film_array = """CREATE TABLE IF NOT EXISTS filmArrayTest (
    ...
    sql_result_group = """CREATE TABLE IF NOT EXISTS resultGroup (
                 ...
                 FOREIGN KEY (test_id) REFERENCES filmArrayTest(test_id));"""

    sql_result = """CREATE TABLE IF NOT EXISTS result (
                 ...
                 FOREIGN KEY (result_group_id) REFERENCES resultGroup(result_group_id));"""
